...
function AdSlot({ label, height = 90 }: { label: string; height?: number }) {
  return (
    <div style={{ background: "#0f0f0f", border: "1px dashed #2a2a2a", borderRadius: 8, padding: "16px", textAlign: "center" as const, color: "#333", fontSize: 11, margin: "20px 0", minHeight: height, display: "flex", alignItems: "center", justifyContent: "center", flexDirection: "column" as const, gap: 3 }}>
          ...
          <div>
            {loading ? (
              ...
              <>
                ...
                {posts.length > 3 && <AdSlot label="In-feed Ad" />}
